...
const char* CTrajectory::TEX_PATH = "data\\TEXTURE\\PARTICLE\\gradation00.jpg";
...
void CTrajectory::Draw()
{
	...
	// ワールドマトリックスの設定
	pDevice->SetTransform(D3DTS_WORLD, &m_mtxWorldTrajectory);
	...
	// テクスチャの設定
	pDevice->SetTexture(0, m_pTextureTrajectory);
