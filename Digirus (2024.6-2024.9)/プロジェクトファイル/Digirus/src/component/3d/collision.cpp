...
void CBoxCollider::AddShapes(btCompoundShape* pShapes)
{
	...
	// リストに追加する
	CManager::GetPhysics()->GetCollisionShape().push_back(box_shape);
}
...
void CSphereCollider::AddShapes(btCompoundShape* pShapes)
{
	...
	// リストに追加する
	CManager::GetPhysics()->GetCollisionShape().push_back(sphere_shape);
}
...
void CCapsuleCollider::AddShapes(btCompoundShape* pShapes)
{
	...
	// リストに追加する
	CManager::GetPhysics()->GetCollisionShape().push_back(capsule_shape);
}
...
void CCylinderCollider::AddShapes(btCompoundShape* pShapes)
{
	...
	// リストに追加する
	CManager::GetPhysics()->GetCollisionShape().push_back(cylinder_shape);
}
...
void CConeCollider::AddShapes(btCompoundShape* pShapes)
{
	...
	// リストに追加する
	CManager::GetPhysics()->GetCollisionShape().push_back(cone_shape);
}